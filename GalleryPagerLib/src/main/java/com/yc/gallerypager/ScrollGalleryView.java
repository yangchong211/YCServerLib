...
import com.yc.gallerypager.impl.GalleryBuilderImpl;
...
public class ScrollGalleryView extends LinearLayout {
    ...
    public ScrollGalleryView addMedia(List<MediaInfo> infos) {
        ...
        for (MediaInfo info : infos) {
            ...
            info.getLoader().loadThumbnail(getContext(), thumbnail, new IMediaLoader.SuccessCallback() {
                @Override
    ...
    public void clearGallery() {
        ...
        // create new adapter
        pagerAdapter = new SlidePagerAdapter(fragmentManager, mListOfMedia, zoomEnabled, innerOnImageClickListener,
    ...
    public static IGalleryBuilder from(ScrollGalleryView galleryView) {
    ...
    private void initializeViewPager() {
        viewPager = (SafeViewPager) findViewById(R.id.viewPager);
